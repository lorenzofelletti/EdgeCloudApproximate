...
KAFKA_TOPICS = "dataout_1,dataout_2,dataout_3,dataout_4,dataout_5,dataout_6"
...
#df_stream = df_stream.withWatermark("time", "1 minutes")
...
while True:
    ...
    if df is not None:
        ...
        #stringify the time
        df = df.withColumn("window", F.concat(F.col("window.start"), F.lit(" "), F.col("window.end")))
